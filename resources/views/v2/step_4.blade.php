    ...
    <div class="page-content-wrapper">
      <div class="container">
        ...
        <div class="checkout-wrapper-area py-3">
                ...
                @csrf
                                   <input type="hidden" name="amount" value="{{$request->p_count}}">
            ...
            <div class="card billing-information-title-card bg-white">
              <div class="card-body pb-0">
                ...
                <p class="text-center mb-0 text-success">
                    <span class="m-1"><i class="lni lni-users"></i> {{$request->p_count}} person  </span>
            ...
            <div class="card user-data-card">
              <div class="card-body pt-0">
                ...
                <div class="single-profile-data d-flex align-items-center justify-content-between">
                  ...
                  <div class="data-content">
                    <input type="text" placeholder="{{$field->input_name}}" name="custom[{{$i}}][{{$field->input_name}}]" class="form-control">
                  </div>
                </div>
                      @endforeach
                ...
                <div class="form-group">
                    <textarea name="" class="form-control" id="" placeholder="You can type your special request…" cols="30" rows="4"></textarea>
                </div>
                <br>
                <div class="form-group">
          ...
          <div class="card cart-amount-area">
            <div class="card-body d-flex align-items-center justify-content-between">
              <h5 class="total-price mb-0 m-1">$<span class="counter">39.84</span></h5>
