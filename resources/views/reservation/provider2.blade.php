...
@endsection
@section('provider_name',$provider->name)
@section('provider_image',$provider->avatar)
@section('content')
                ...
                <div class="choice" data-toggle="wizard-radio" rel="tooltip"  onclick="getModels({{$category->id}})" title="{{$category->title}}" >
                  <input type="radio" name="category" value="{{$category->id}}">
                    <div class="icon" style="padding: 15px;border-radius: 25%;">
                      <img src="{{$category->avatar}}" style="width: -moz-available;border-radius: 25%;   width: -webkit-fill-available;  /* For Chrome */
  width: stretch;        width: 100%;" alt="">
